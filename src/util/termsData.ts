...
본 이용약관은 “사단법인 특수교육디지털교육협회”(이하 "협회")의 서비스의 이용조건과 운영에 관한 제반 사항 규정을 목적으로 합니다.
...
이 약관은 2024년도 10월부터 시행합니다.`;

export const PRIVACY_POLICY = `1. 개인정보 수집목적 및 이용목적
...
export const MARKETING_CONSENT = `이벤트, 신상품 소식, 고객 혜택 등 다양한 정보 제공`;
